...
export default function CostChip({ bannerId, recordVersion = 0 }) {
  const [open, setOpen] = useState(false)

  // Re-read on every recordVersion bump (a generation just landed) and on
  // open/close so the modal sees fresh data on subsequent opens.

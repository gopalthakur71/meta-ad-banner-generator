...
export function renderCarousel(ctx, { W, H, productImg, logoImg, copy, palette, layout, logoVisible, logoOpacity, logoScale, logoDensity, headlineFont, customTextColor = '#FFFFFF', textOffsets = {}, onElement, logoOffset = {}, imageRect = null, headlineFontSize = 1, subFontSize = 1, ctaColor, badgeColor }) {
  ctx.fillStyle = palette.background
  ctx.fillRect(0, 0, W, H)

  const imgH = Math.floor(H * 0.62)
  if (productImg) {
    const frame = { x: 0, y: 0, w: W, h: imgH }
